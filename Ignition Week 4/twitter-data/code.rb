...
# 1
puts "User descriptions:"
twitter_data.each do |users|
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["number of followers"].nil?
      puts "*#{user}: N/A"
    else
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["latest tweet"].nil?
      puts "*#{user} doesn't have a latest tweet."
    else
      puts "*#{user}'s latest tweet was #{info["latest tweet"].length} characters long."
    end
  end
end
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["last twenty tweets"].nil?
      puts "*#{user} doesn't have any tweets to count"
    else
      info["last twenty tweets"].each do |tweet|
        characters += tweet.length
      end
      puts "*#{user} used #{characters} characters in their last twenty tweets."
    end
  end
end
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["number of followers"] > followers
      followers = info["number of followers"]
      most_followers = user
    end
  end
end
puts "#{most_followers} has the most twitter followers."
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["number of friends"] > friends
      friends = info["number of friends"]
      most_friends = user
    end
  end
end
puts "#{most_friends} has the most friends."
...
twitter_data.each do |users|
  users.each do |user, info|
    if info["number of tweets"] > tweets
      tweets = info["number of tweets"]
      most_tweets = user
    end
  end
end
puts "#{most_tweets} has tweeted the most times."


puts "\nThese users have a description listed:"
twitter_data.each do |users|
  users.each do |user, info|
    if !info["description"].nil?
      puts "*#{user}"
...
puts "\nThese users have a location listed:"
twitter_data.each do |users|
  users.each do |user, info|
